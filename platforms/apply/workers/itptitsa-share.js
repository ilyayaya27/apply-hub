...
const CLOSED_RE = /вакансия.{0,60}(не актуальна|закрыт|закрыли)|не актуальна|позиция.{0,30}закрыт|закрыли вакансию|завершил.{0,20}поиск|поиск завершён|поиск.{0,10}закрыт/i;
